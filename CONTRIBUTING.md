# Contributing to KitoImageLoader
...
3. Make your change. Follow
   [KitoImageLoader's engineering standards](https://github.com/WykSofts-Inc/KitoImageLoader/blob/main/docs/ENGINEERING_STANDARDS.md) —
